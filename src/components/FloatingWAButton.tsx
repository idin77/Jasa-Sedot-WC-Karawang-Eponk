...
export default function FloatingContactButtons() {
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      {/* Phone Call Button */}
      <a
        href="tel:0858-1769-2245"
        className="flex items-center gap-2 bg-blue-600 text-white px-5 py-3 rounded-full shadow-2xl hover:bg-blue-700 transition-all transform hover:scale-105 duration-300"
      >
        <Phone size={20} />
